...
const SITE_STRINGS = {
  en: {
    ...
    'contact.eventLink': 'Your TruckersMP Convoy Link',
    'contact.placeholder.eventLink': 'https://truckersmp.com/events/34097-northstar-group-opening-convoy',
    'contact.eventLinkHint': "Paste a link to the convoy you'd like to invite us to and we'll pick up the name automatically.",
  ...
  bg: {
    ...
    'contact.eventLink': 'Твой линк към TruckersMP конвой',
    'contact.placeholder.eventLink': 'https://truckersmp.com/events/34097-northstar-group-opening-convoy',
    'contact.eventLinkHint': 'Постави линк към конвоя, на който искаш да те поканим, и ние ще извлечем името автоматично.',
