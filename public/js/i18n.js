...
const SITE_STRINGS = {
  en: {
    ...
    'media.news.rsText': 'Our official recognition and authority system that ranks every driver, rewarding activity with titles from Newbie to Champion.',
    'media.news.rsTitle': 'Reputation System',
  ...
  bg: {
    ...
    'media.news.rsText': 'Нашата официална система за признание и авторитет, която ранжира всеки шофьор и награждава активността с рангове от Newbie до Champion.',
    'media.news.rsTitle': 'Система за репутация',
