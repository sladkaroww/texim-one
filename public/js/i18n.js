...
const SITE_STRINGS = {
  en: {
    ...
    'contact.emailNote': 'We confirm attendance by email. If we can\'t reach you on Discord, we\'ll use this email to accept or decline your invite.',
    ...
    'contact.required': 'Please fill in all required fields (Convoy Name, Date, Email).',
    'contact.sent': 'Invite Sent!',
    'contact.sentText': 'Your convoy invite has been sent. We will confirm attendance by email (or Discord).',
    'contact.declinedTitle': 'Auto-Declined — Date Conflict',
    'contact.declinedText': 'We already have a TEXIM ONE convoy on that date, so this invite was automatically declined. We\'ll email you to confirm.',
  ...
  bg: {
    ...
    'contact.emailNote': 'Потвърждаваме участието по имейл. Ако не можем да те достигнем в Discord, ще използваме този имейл, за да приемем или откажем поканата.',
    ...
    'contact.required': 'Моля, попълни всички задължителни полета (Име на конвоя, Дата, Имейл).',
    'contact.sent': 'Поканата е изпратена!',
    'contact.sentText': 'Поканата ти за конвой е изпратена. Ще потвърдим участието по имейл (или в Discord).',
    'contact.declinedTitle': 'Автоматично отказана — конфликт в датата',
    'contact.declinedText': 'Вече имаме конвой на TEXIM ONE на тази дата, затова поканата е автоматично отказана. Ще ти пишем по имейл за потвърждение.',
