...
const SITE_STRINGS = {
  en: {
    ...
    'contact.discordNote': 'Crucial: join our Discord (https://discord.com/invite/2sSKVKXUtn) so we can DM you when we accept or decline. We no longer email invites.',
  ...
  bg: {
    ...
    'contact.discordNote': 'Важно: присъедини се към нашия Discord (https://discord.com/invite/2sSKVKXUtn), за да ти пишем лично съобщение при приемане или отказ. Вече не изпращаме имейли.',
