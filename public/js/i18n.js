...
const SITE_STRINGS = {
  en: {
    ...
    'contact.discord': 'Discord Tag *',
    'contact.email': 'Email Address',
    'contact.convoyName': 'Convoy Name / Event *',
    'contact.pickConvoyLabel': 'Select One of Our Convoy Lists',
    'contact.pickConvoy': 'Select a convoy',
    'contact.eventLink': '…or Paste a TruckersMP Event Link',
    'contact.placeholder.eventLink': 'https://truckersmp.com/events/34097',
    'contact.eventLinkHint': 'Pick a convoy from the list above, or paste a link to one of our events to auto-fill.',
    'contact.loadingEvent': 'Loading event details...',
    'contact.eventLoaded': 'Event details loaded — you can add extra info below.',
    'contact.eventManual': 'Could not auto-fill this event — please enter the details manually below.',
    'contact.manualPlaceholder': 'Enter Convoy Name Manually...',
    'contact.date': 'Preferred Date *',
    'contact.time': 'Preferred Time (UTC) *',
    ...
    'contact.note': '* Required fields. Your information will be sent directly to our Discord team.',
    'contact.sent': 'Invite Sent Successfully!',
    'contact.sentText': 'Your convoy invite has been sent to our team on Discord. We\'ll review it and respond soon.',
  ...
  bg: {
    ...
    'contact.discord': 'Discord таг *',
    'contact.email': 'Имейл адрес',
    'contact.convoyName': 'Име на конвоя / събитието *',
    'contact.pickConvoyLabel': 'Избери от нашите конвои',
    'contact.pickConvoy': 'Избери конвой',
    'contact.eventLink': '…или постави линк към TruckersMP събитие',
    'contact.placeholder.eventLink': 'https://truckersmp.com/events/34097',
    'contact.eventLinkHint': 'Избери конвой от списъка по-горе или постави линк към наше събитие за автоматично попълване.',
    'contact.loadingEvent': 'Зареждане на детайлите на събитието...',
    'contact.eventLoaded': 'Детайлите са заредени — можеш да добавиш още информация по-долу.',
    'contact.eventManual': 'Не можахме да заредим автоматично това събитие — моля, въведи детайлите ръчно по-долу.',
    'contact.manualPlaceholder': 'Въведи име на конвоя ръчно...',
    'contact.date': 'Предпочитана дата *',
    'contact.time': 'Предпочитано време (UTC) *',
    ...
    'contact.note': '* Задължителни полета. Информацията ви ще бъде изпратена директно до нашия Discord екип.',
    'contact.sent': 'Поканата е изпратена успешно!',
    'contact.sentText': 'Поканата ви за конвой е изпратена до нашия екип в Discord. Ще я прегледаме и ще отговорим скоро.',
